...
func (r *SearchReconciler) IndexerDeployment(instance *searchv1alpha1.Search, tlsEnvVars []corev1.EnvVar) *appsv1.Deployment {
	...
	indexerContainer.SecurityContext = getContainerSecurityContext()
